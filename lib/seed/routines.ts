...
const saturdayItems: RoutineItemDef[] = [
  ...
  item({
    ...
    block: "volume",
    prescription: { sets: 4, reps_per_set: 10, load_kg: 0, rest_seconds: 0, notes: "Then dips" },
    rest_seconds: 0,
    load_from_state: true,
  ...
  item({
    ...
    block: "volume",
    prescription: { sets: 3, reps_per_set: 12, rest_seconds: 0, notes: "Then push-ups" },
    rest_seconds: 0,
  ...
  item({
    ...
    prescription: {
      ...
      reps_per_set: 8,
      rest_seconds: 0,
      notes: "Then mountain climbers",
      extras: { circuit_with: "mountain-climber", round_rest: 30 },
    },
    rest_seconds: 0,
